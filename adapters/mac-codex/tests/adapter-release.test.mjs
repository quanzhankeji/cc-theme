...
try {
  ...
  const expectedIdentity = `mac-codex-${adapterVersion}-r3-macos-arm64`;
  ...
  assert.equal(manifest.adapterReleaseRevision, 3);
  ...
  assert.equal(result.adapterReleaseRevision, 3);
