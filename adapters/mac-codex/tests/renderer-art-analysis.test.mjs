...
source = source
  ...
  .replace("__THEME_EDITOR_LOCALES_JSON__", JSON.stringify({ defaultLocale: "en", locales: ["en"], messages: {}, groupLabels: {}, tokenLabels: {} }))
  .replace("__THEME_STYLE_OVERRIDES_JSON__", JSON.stringify({}))
  .replace("__THEME_RUNTIME_PREFERENCES_JSON__", JSON.stringify({}))
  .replace("__THEME_OVERRIDE_STATE_JSON__", JSON.stringify({ status: "absent", diagnostics: [], quarantine: { entries: [] } }))
