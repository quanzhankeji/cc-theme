...
当前 arm64 用户包为
`cc-theme-mac-codex-26.715.71837-r2-macos-arm64.zip`，源码包为
`mac-codex-26.715.71837-r2-macos-arm64.zip`，校验文件分别为
`cc-theme-mac-codex-26.715.71837-r2-macos-arm64.zip.sha256` 和
`mac-codex-26.715.71837-r2-macos-arm64.zip.sha256`。
